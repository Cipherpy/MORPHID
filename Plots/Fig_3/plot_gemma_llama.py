...
# -------------------- INPUTS -------------------
GEMMA_CSV = "/home/reshma/MORPHID/Plots/Fig_3/gemma/plots/caption_scores_all.csv"
LLAMA_CSV = "/home/reshma/MORPHID/Plots/Fig_3/llama/plots/llama_caption_scores_all.csv"
...
ax_left.legend(loc="lower right", frameon=False, fontsize=8, ncols=2, handlelength=1.2, columnspacing=1.5)
...
if SHOW_DELTA_LABELS:
    for i, d in enumerate(merged['delta'].values):
        ...
        ax_right.text(x, i, f"{d:+.2f}", va='center', ha=ha, fontsize=7)
...
out_png = "/home/reshma/MORPHID/Plots/Fig_3/plots/gemma_vs_llama_dumbbell_delta.png"
out_pdf = "/home/reshma/MORPHID/Plots/Fig_3/plots/gemma_vs_llama_dumbbell_delta.pdf"
