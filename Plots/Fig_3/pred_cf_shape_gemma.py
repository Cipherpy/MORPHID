...
OUT_PNG        = os.path.join(OUT_DIR, "shape_dotmatrix_correct_vs_wrong_gemma.png")  # keep name for compatibility

# Extra outputs for metrics
OUT_REPORT_TXT   = os.path.join(OUT_DIR, "shape_classification_report_gemma.txt")
OUT_REPORT_CSV   = os.path.join(OUT_DIR, "shape_classification_report_gemma.csv")
OUT_SUMMARY_JSON = os.path.join(OUT_DIR, "shape_summary_metrics_gemma.json")
